...
The **Voice** dropdown picks one source:

- **British** — Amy MP3s (“the time is”, numbers, o’clock, noon, midnight, AM/PM)
  and the third-stroke chime (`088` / `089`)
- **German** — Deutsch-Zeitansage WAVs: `Beim nächsten Ton ist es`,
  `Stunden/N Uhr`, `Minuten/N Minuten`, `Sekunden/und N Sekunden`
  (0/10/20/30/40/50), and `Signalton`
- **Computer voice** — browser speech of the lit plate phrase
